    ...
    return (
        <nav className="w-full bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 h-20 md:h-24 flex flex-col items-center justify-center">
                {/* HDFC Logo at top */}
                <div className="mb-2">
                    <img src="https://www.hdfcbank.com/content/api/contentstream-id/723fb80a-2dde-42a3-9793-7ae1be57c87f/297c88c7-24a3-41c1-9257-268e3981881a?" alt="HDFC Bank" className="h-6 md:h-8" />
                </div>
            ...
            {/* Visual progress bar at extreme top */}
            <div className="absolute top-0 left-0 w-full h-[3px] bg-slate-100 overflow-hidden">
                <div
                    ...
                    style={{ width: `${((currentStepIndex + 1) / journeySteps.length) * 100}%` }}
                />
            </div>
        </nav>
    );
