        ...
        <div className="w-full py-2 bg-transparent">
            <div className="max-w-6xl mx-auto">
                <div className="flex items-center justify-between relative gap-2">
                    ...
                    <div
                        className="absolute top-1/2 left-0 h-[2px] transition-all duration-1000 ease-in-out z-0 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.05)]"
                        style={{
                    ...
                    {journeySteps.map((step, index) => {
                        ...
                        return (
                            <div key={step.id} className="relative z-10 flex flex-col items-center flex-1 min-w-0 group">
                                <div
                                    className={cn(
                                        "w-6 h-6 md:w-8 md:h-8 rounded-lg flex items-center justify-center text-[10px] md:text-xs font-semibold transition-all duration-500",
