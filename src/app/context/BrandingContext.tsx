...
export function BrandingProvider({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        document.documentElement.style.setProperty('--primary-bank', config.primary);
        document.documentElement.style.setProperty('--radius-bank', `${config.borderRadius}px`);
        document.documentElement.style.setProperty('--font-bank', config.fontFamily);
    }, [config]);
